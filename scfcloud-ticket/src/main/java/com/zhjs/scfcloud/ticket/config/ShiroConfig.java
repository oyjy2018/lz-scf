...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager){
        ...
        //对所有用户认证
        map.put("/index","anon");
        map.put("/businessTicket/inquireList","anon");
        map.put("/platform/jdzpNotify","anon");
        map.put("/notify/jd/asyncnotify","anon");
        map.put("/sign/createOrganize","anon");
        map.put("/sign/createPerson","anon");
        map.put("/banner/getCarousel","anon");
        map.put("/**","authc");
        //首页
