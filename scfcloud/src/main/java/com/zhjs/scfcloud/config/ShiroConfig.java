...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager){
        ...
        map.put("/user/acceptInviteAndRegister", "anon");
        map.put("/user/acceptInvite", "anon");
        map.put("/user/isRegisterPhone", "anon");
        map.put("/user/checkIsNewUser", "anon");
        map.put("/company/active/**", "anon");
        map.put("/business/initCompanyFlowPermit", "anon");
        map.put("/quartz/**", "anon");
        //对所有用户认证
        map.put("/**","authc");
        //首页
...
//        filterMap.put("nginxFilter", new NginxFilter());
    ...
    public RedisManager redisManager(){
        ...
        redisManager.setDatabase(Integer.valueOf(env.getProperty("spring.redis.database")));
        return redisManager;
    }
    ...
    public RedisCacheManager redisCacheManager(){
        ...
        //缓存过期时间（秒）
        redisCacheManager.setExpire(4000);
