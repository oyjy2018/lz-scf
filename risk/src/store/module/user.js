...
export default {
  ...
  actions: {
    ...
    // 公司激活
    companyActive ({ state, commit }, { companyAuditId }) {
      return new Promise((resolve, reject) => {
        companyActive({ companyAuditId }).then(res => {
          resolve(res)
        }).catch(err => {
          reject(err)
        })
    ...
    // 重发公司激活邮件
    sendCompanyActiveEmail ({ state, commit }, { companyAuditId }) {
      return new Promise((resolve, reject) => {
        sendCompanyActiveEmail({ companyAuditId }).then(res => {
          resolve(res)
        }).catch(err => {
          reject(err)
        })
    ...
    // 用户接受邀请并注册（新用户）
    acceptInviteAndRegister ({ commit }, data) {
      return new Promise((resolve, reject) => {
        acceptInviteAndRegister(data).then(res => {
          resolve(res)
        }).catch(err => {
          reject(err)
        })
    ...
    // 获取验证码
    phoneCheck ({ state, commit }, { phone }) {
      return new Promise((resolve, reject) => {
        phoneCheck({ phone }).then(res => {
          resolve(res)
        }).catch(err => {
          reject(err)
        })
    ...
    // 获取邮箱验证码
    getEmailVCode ({ state, commit }, { email, userName }) {
      return new Promise((resolve, reject) => {
        getEmailVCode({ email, userName }).then(res => {
          resolve(res)
        }).catch(err => {
          reject(err)
        })
    ...
    // 验证邮箱是否注册
    checkedRegisterEmail ({ state, commit }, { email }) {
      return new Promise((resolve, reject) => {
        checkedRegisterEmail({ email }).then(res => {
          resolve(res)
        }).catch(err => {
          reject(err)
        })
    ...
    // 查询用户所在公司成员
    findCompanyUser ({ state, commit }, data) {
      return new Promise((resolve, reject) => {
        findCompanyUser(data).then(res => {
          resolve(res)
        }).catch(err => {
          reject(err)
        })
    ...
    // 查询是否通过邮箱验证
    checkIsNewUser ({ state, commit }, data) {
      return new Promise((resolve, reject) => {
        checkIsNewUser(data).then(res => {
          resolve(res)
        }).catch(err => {
          reject(err)
        })
